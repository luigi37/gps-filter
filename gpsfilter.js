...
"use strict";
/*
  https://github.com/jzeiders/gps-filter
...
window.GPSpositionFilter = function (points,min,max){
...
// returns arrayOfFilteredPoints
    ...
    var newpoints=gpsfilter.positionFilter(points,min,max);
    return newpoints;
}

window.GPSvelocityFilter = function (points,min,max){
// .velocityFilter(points,min,max)
//   #Removes points where the velocity is outside the bounds
//   returns arrayOfFilteredPoints

    var gpsfilter = require('gps-filter');
    var newpoints=gpsfilter.velocityFilter(points,min,max);
    return newpoints;
}

window.GPSaccelerationFilter = function (points,min,max){
// .accelerationFilter(points,min,max)
//   #Removes points where the acceleration is outside the bounds
//   returns arrayOfFilteredPoints

    var gpsfilter = require('gps-filter');
    var newpoints=gpsfilter.accelerationFilter(points,min,max);
    return newpoints;
}

window.GPSremoveSpikes = function (points,sharpness,iterations){
...
//   returns arrayOfFilteredPoints
    ...
    var gpsfilter = require('gps-filter');
    var newpoints=gpsfilter.removeSpikes(points,sharpness,iterations);
    return newpoints;
}

window.GPSsmoothLine = function (points,threshold){
...
//   returns arrayOfFilteredPoints
    ...
    var gpsfilter = require('gps-filter');
    var newpoints=gpsfilter.smoothLine(points,threshold);
    return newpoints;
}
},{"gps-filter":2}],2:[function(require,module,exports){
...
},{"vectorize":5}],3:[function(require,module,exports){
//! moment.js
//! version : 2.17.1
...
},{"speed-filter":4,"victor":6}],6:[function(require,module,exports){
